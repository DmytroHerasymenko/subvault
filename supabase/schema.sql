...
create table if not exists public.profiles (
  ...
  display_name text,
  preferred_currency text not null default 'EUR' check (preferred_currency in ('UAH', 'USD', 'EUR', 'PLN', 'CZK', 'CHF', 'GBP')),
  locale text not null default 'en' check (locale in ('ua', 'en', 'pl', 'de', 'cs', 'es', 'fr', 'it')),
...
create table if not exists public.subscriptions (
  ...
  currency text not null check (currency in ('UAH', 'USD', 'EUR', 'PLN', 'CZK', 'CHF', 'GBP')),
